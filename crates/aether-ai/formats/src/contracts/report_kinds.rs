...
pub const TYPESAFE_SYSTEMONE_SYNC_SUCCESS_REPORT_KIND: &str = "typesafe_systemone_sync_success";
pub const TYPESAFE_SYSTEMONE_SYNC_FINALIZE_REPORT_KIND: &str = "typesafe_systemone_sync_finalize";
...
pub fn implicit_sync_finalize_report_kind(plan_kind: &str) -> Option<&'static str> {
    match plan_kind {
        ...
        TYPESAFE_SYSTEMONE_SYNC_PLAN_KIND => Some(TYPESAFE_SYSTEMONE_SYNC_FINALIZE_REPORT_KIND),
...
pub fn core_error_default_client_api_format(report_kind: &str) -> Option<&'static str> {
    match report_kind {
        ...
        TYPESAFE_SYSTEMONE_SYNC_FINALIZE_REPORT_KIND => Some("typesafe:systemone"),
...
pub fn core_error_background_report_kind(report_kind: &str) -> Option<&'static str> {
    match report_kind {
        ...
        TYPESAFE_SYSTEMONE_SYNC_FINALIZE_REPORT_KIND => None,
...
pub fn core_success_background_report_kind(report_kind: &str) -> Option<&'static str> {
    match report_kind {
        ...
        TYPESAFE_SYSTEMONE_SYNC_FINALIZE_REPORT_KIND => Some(TYPESAFE_SYSTEMONE_SYNC_SUCCESS_REPORT_KIND),
